...
def create_invoice():
    ...
    if form.validate_on_submit():
        ...
        # ✅ snapshot with updated model columns
        invoice = Invoice(
            sale_id=sale.id,
            customer_name=sale.customer.name,  # use customer_name
            product_name=sale.product.name,    # use product_name
    ...
    # ✅ convert sales into JSON-serializable dicts
    sales_data = [
        {
            "id": sale.id,
