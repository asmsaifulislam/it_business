...
class CustomerForm(FlaskForm):
    name = StringField('Customer Name', validators=[DataRequired()], render_kw={"placeholder": "Enter full name"})
    email = StringField('Email Address', validators=[DataRequired(), Email()], render_kw={"placeholder": "Enter email"})
    mobile = StringField('Mobile Number', validators=[DataRequired(), Length(min=6, max=20)], render_kw={"placeholder": "Enter mobile number"})
